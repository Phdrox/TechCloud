...
export default function Home() {
  ...
  return (
    <div className='grid grid-rows-6 mobile:grid-cols-1 min-h-screen tablet:grid-cols-2 tablet:grid-rows-4 overflow-x-hidden' id='Home'>
      <Navbar/>
    <div className='row-span-1 mobile:gap-4 bg-no-repeat bg-cover flex items-center justify-center mobile:col-span-1 mobile:flex-col tablet:col-span-2 notebook:flex-row' id={styles.home}>
